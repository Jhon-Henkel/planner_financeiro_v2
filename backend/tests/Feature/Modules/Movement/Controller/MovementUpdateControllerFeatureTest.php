...
class MovementUpdateControllerFeatureTest extends FeatureTestCase
{
    ...
    public function testRouteTestOne()
    {
        ...
        $response = $this->putJson(route(RouteNameEnum::ApiMovementUpdate, ['id' => $movementId]), [
            'description' => 'PHP Unit Test Movement Updated',
            'amount' => 100,
        ], $this->makeHeaders());
