...
namespace Tests\Feature\Modules\Movement\Controller;
...
class MovementDetailsControllerFeatureTest extends FeatureTestCase
{
    ...
    public function testRoute()
    {
        ...
        $response = $this->getJson(route(RouteNameEnum::ApiMovementDetails, ['id' => $response->json('data.id')]), $this->makeHeaders());
